<footer class="site-footer">
    <div class="container">
        <div class="footer-grid">
            <div>
                ...
                <p style="max-width:320px; font-size:0.9rem; margin-top:12px;">
                    <?php echo clean(getSetting($conn, 'site_tagline', 'Helping people find the right place to call home. Browse our listings or reach out and our team will help you find a property that fits your needs.')); ?>
                </p>
                <div class="social-links" style="margin-top: 20px; display: flex; gap: 15px;">
                    <a href="<?php echo htmlspecialchars(getSetting($conn, 'social_facebook', '#')); ?>" target="_blank" style="color: rgba(255,255,255,0.8); text-decoration: none; font-size: 0.95rem; font-weight: 500; display: inline-flex; align-items: center; gap: 6px;">
                    ...
                    <a href="<?php echo htmlspecialchars(getSetting($conn, 'social_whatsapp', '#')); ?>" target="_blank" style="color: rgba(255,255,255,0.8); text-decoration: none; font-size: 0.95rem; font-weight: 500; display: inline-flex; align-items: center; gap: 6px;">
                    ...
                    <a href="<?php echo htmlspecialchars(getSetting($conn, 'social_tiktok', '#')); ?>" target="_blank" style="color: rgba(255,255,255,0.8); text-decoration: none; font-size: 0.95rem; font-weight: 500; display: inline-flex; align-items: center; gap: 6px;">
            ...
            <div>
                ...
                <ul>
                    ...
                    <li><a href="<?php echo $baseUrl ?? ''; ?>properties.php?type=Commercial">Commercial</a></li>
                </ul>
            </div>
            <div>
                <h4>Contact</h4>
                <ul>
                    <li><?php echo clean(getSetting($conn, 'address', 'Airport Road, Hargeisa, Somaliland')); ?></li>
                    <?php $phone = clean(getSetting($conn, 'contact_phone', '+252 63 4567890')); ?>
        ...
        <div class="footer-bottom">
            &copy; <?php echo date('Y'); ?> <?php echo clean(getSetting($conn, 'site_name', 'Guryo Samo')); ?>. All rights reserved. &mdash; University Graduation Project.
        </div>
    </div>
</footer>
